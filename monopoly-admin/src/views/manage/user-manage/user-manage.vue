...
<template>
	<div class="user-page">
		<el-row class="top-bar">
			<el-col :span="20" class="title"><h4>用戶管理</h4></el-col>
			<el-col :span="4" class="button-container">
				<!-- <el-button class="button-create-user" type="primary" @click="_dialogVisible = true">創建用戶</el-button> -->
			</el-col>
		</el-row>
		...
		<el-table fit v-loading="isLoading" border :data="_userList" class="user-list-container">
			...
			<el-table-column align="center" label="用戶名" prop="username"></el-table-column>
